...
VALUES ('2022-01-04 02:15:01', '2022-04-04 40:14:03', (SELECT user_id FROM Users WHERE username = 'Titan'),  (SELECT game_id FROM Games WHERE game_title = 'Elden Ring')),
('2021-11-01 01:30:40', '2022-01-12 100:24:10',(SELECT user_id FROM Users WHERE username = 'Erennn'), (SELECT game_id FROM Games WHERE game_title = 'Overwatch')),
